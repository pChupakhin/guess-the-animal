...
<li> what animal the user had in mind, and
<li> what statement can help the computer distinguish the animal it guessed (old) from the animal that the person actually thought of (new).The program should only accept statements of a certain template: "It can/has/is...".
<li> the program should clarify whether that fact is correct for the new animal.
